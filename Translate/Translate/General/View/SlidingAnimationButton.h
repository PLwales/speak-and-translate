...
@interface SlidingAnimationButton : UIView
...
//YES：设置比较多的按钮时，点击后使按钮显示在中间
@property (nonatomic, assign) BOOL isOffsetAuto;
/**
...
@interface SlidingAnimationButtonCell : UICollectionViewCell
